def loop(l):
    ...
    while loop:
        ...
        if yn.upper() == "N":
            ...
            print(l)
def updatedictionary(lap_num,dicton,quantity_laptop,laplist):
...
def updatedictionary1(lap_num,dicton,quantity_laptop,laplist1):
    value = int(dicton[lap_num][3])
    dicton[lap_num][3] = value + quantity_laptop
...
def laptopQuantity(dict,lap_num):
    loop_test = True
    while loop_test:
        try:
